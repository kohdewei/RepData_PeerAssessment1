...
The median is **`r stepsPerDayMedian`** and the mean is **`r stepsPerDayMean`**.
...
The 5-minute interval starting at **`r maxInterval` mins** contains the maximum number of steps on average across all days in the dataset.
...
There are a total of **`r numMissingValues`** missing values in the dataset.
...
The median is **`r stepsPerDayMedianImputed`** and the mean is **`r stepsPerDayMeanImputed`**.
